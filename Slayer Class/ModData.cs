...
public static class ModData
{
    ...
    public static class Tooltips
    {
        ...
        public static readonly string SlayersTricksAbility = RegisterInfoTooltip(
            ID_PREPEND + "Ruling.SlayersTricksAbility",
            """
            {b}Slayer's Tricks{/b}
            {i}Technical Limitation — Spellcasting Ability{/i}

            Due to technical limitations, your character sheet will not reflect a Wisdom spellcasting ability for your slayer spells until you enter an encounter.

            This is a purely cosmetic limitation.
            """);
        
        public static readonly string SpellSlatesTraditions = RegisterInfoTooltip(
            ID_PREPEND + "Ruling.SpellSlatesTraditions",
            """
            {b}Spell Slates{/b}
            {i}Ruling — Multiple Traditions{/i}

            Trophy traditions are described in plural language, being associated with multiple traditions. This feature, however, was described using the singular "tradition".
            
            In order to resolve this discrepancy, this has been changed to plural language. Each tradition on a trophy adds to the list of options available when you Reinforce your Arsenal.
            """);
        
        #endregion
         
        /// <summary>
        /// Registers a tooltip and assigns a text function that uses the tooltip.
        /// </summary>
    ...
    public static class Traits
    {
        ...
        /// <summary>
        /// This trait identifies the source trait for spells generated by the Reinforced benefits of the Spell Slates secondary hunting tool. This is a separate source trait from <see cref="Slayer"/>.
        /// </summary>
        public static readonly Trait ReinforcedSlateSpell = ModManager.RegisterTrait(
            "Reinforced Spell Slate", new TraitProperties("Reinforced Spell Slate", false));
