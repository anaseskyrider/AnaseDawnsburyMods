...
public static class ArchetypeScout
{
    public static void LoadMod()
    {
        ...
        Feat scoutsWarning = new TrueFeat(
        ...
        ModManager.AddFeat(scoutsWarning);
        ...
        ModManager.AddFeat(scoutDedication);
        
        // Lv4: Scout's Charge
        Feat scoutsCharge = new TrueFeat(
            ...
            .WithActionCost(2)
            .WithAvailableAsArchetypeFeat(ModData.Traits.ScoutArchetype)
            .WithPermanentQEffect("Choose an enemy. Stride, Feint, and Strike them.", qfFeat =>
            {
                qfFeat.ProvideMainAction = qfThis =>
                {
                    CombatAction chargeAction = new CombatAction(
                            ...
                            "Scout's Charge",
                            [Trait.Basic, Trait.Archetype, Trait.Flourish],
        ...
        ModManager.AddFeat(scoutsCharge);

        // Lv4: Terrain Scout (probably no)

        // Lv6: Fleeting Shadow
        Feat fleetingShadow = new TrueFeat(
            ...
            .WithActionCost(2)
            .WithAvailableAsArchetypeFeat(ModData.Traits.ScoutArchetype)
            .WithPermanentQEffect("Hide, then Sneak twice.", qfFeat =>
            {
                qfFeat.ProvideMainAction = qfThis =>
                {
                    CombatAction fleetAction = new CombatAction(
                            ...
                            "Fleeting Shadow",
                            [Trait.Basic, Trait.Archetype, Trait.Flourish, Trait.DoesNotBreakStealth],
        ...
        ModManager.AddFeat(fleetingShadow);

        // Lv6: Scout's Speed
        Feat scoutsSpeed = new TrueFeat(
            ...
            .WithAvailableAsArchetypeFeat(ModData.Traits.ScoutArchetype)
            .WithPermanentQEffect("Gain a +10-foot status bonus to your Speed.", qfFeat =>
            {
                qfFeat.BonusToAllSpeeds = qfThis =>
                    new Bonus(2, BonusType.Status, "Scout's Speed");
            });
        ModManager.AddFeat(scoutsSpeed);
