    ...
    public static IEnumerable<Feat> CreateFeats()
    {
        ...
        yield return new TrueFeat(
            ...
            .WithPermanentQEffect(
                "Reduce poisons you save against by an additional stage.",
                qfFeat =>
                {
        ...
        yield return new TrueFeat(
                ...
                [ModData.Traits.AndroidAncestry])
            .WithPermanentQEffect(
                "You're more likely to succeed and critically succeed at saving throws against emotion and fear effects.",
                qfFeat =>
                {
        ...
        yield return new TrueFeat(
                ...
                [ModData.Traits.AndroidAncestry])
            .WithPermanentQEffect(
                "The first item you draw or replace is a free action.",
                qfFeat =>
                {
        ...
        yield return new TrueFeat(
            ...
            .WithActionCost(-2)
            .WithPermanentQEffect(
                "Once per combat, boost a skill check you're about to attempt.",
                qfFeat =>
                {
        ...
        yield return new TrueFeat(
                ...
                $"You can cast {LibraryOfAnase.CreateSpellLink(SpellId.SeeInvisibility, ModData.Traits.AndroidAncestry, 2)} once per day as a 2nd-level arcane innate spell.",
                [ModData.Traits.AndroidAncestry])
            .WithIllustration(IllustrationName.SeeInvisibility)
            .WithRulesBlockForSpell(SpellId.SeeInvisibility, ModData.Traits.AndroidAncestry, 2)
            .WithOnCreature(cr =>
            {
        ...
        yield return new TrueFeat(
                ...
                "You gain the {link:IncredibleInitiative}Incredible Initiative{/} general feat.",
                [ModData.Traits.AndroidAncestry])
        ...
        yield return new TrueFeat(
                ...
                $"You can cast {LibraryOfAnase.CreateSpellLink(SpellId.TrueStrike, ModData.Traits.AndroidAncestry, 1)} once per day as a 1st-level arcane innate spell.",
                [ModData.Traits.AndroidAncestry])
            .WithIllustration(IllustrationName.TrueStrike)
            .WithRulesBlockForSpell(SpellId.TrueStrike, ModData.Traits.AndroidAncestry, 1)
            .WithOnCreature(cr =>
            {
        ...
        yield return new TrueFeat(
            ...
            .WithActionCost(2)
            .WithPermanentQEffect(
                "Once per day, you can become concealed temporarily.",
                qfFeat =>
                {
                    qfFeat.ProvideMainAction = qfThis =>
                    {
        ...
        yield return new TrueFeat(
                ...
                [ModData.Traits.AndroidAncestry])
            .WithPermanentQEffect(
                "You can use Nanite Surge {icon:Reaction} with saving throws.",
                qfFeat =>
                {
                    qfFeat.BeforeYourSavingThrow = async (qfThis, action, self) =>
                    {
        ...
        yield return new TrueFeat(
            ...
            .WithActionCost(1)
            .WithPermanentQEffect(
                "You gain swimming for the rest of the encounter.",
                qfFeat =>
                {
        ...
        yield return new TrueFeat(
                ...
                [ModData.Traits.AndroidAncestry])
            .WithPermanentQEffect(
                "You can use Nanite Surge {icon:Reaction} with attack rolls.",
                qfFeat =>
                {
        ...
        yield return new TrueFeat(
            ...
            .WithActionCost(1)
            .WithPermanentQEffect(
                "Gain fast healing for the rest of the encounter, blocking nanite abilities for the duration.",
                qfFeat =>
                {
                    qfFeat.ProvideMainAction = qfThis =>
                    {
        ...
        yield return new TrueFeat(
                ...
                [ModData.Traits.AndroidAncestry])
            .WithPermanentQEffect(
                "You can use Nanite Surge twice instead of once per encounter.",
                qfFeat =>
                {
        ...
        yield return new TrueFeat(
            ...
            .WithActionCost(0)
            .WithPermanentQEffect(
                "Once per day, your nanites can avoid your dying.",
                qfFeat =>
                {
