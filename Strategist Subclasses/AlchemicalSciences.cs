    ...
    public static Feat CreateSubclass(Feat strategist)
    {
        Feat alchemicalSciences = new Feat(
                ...
                $$"""
                  ...
                  {{ModData.Illustrations.DdSun.IllustrationAsIconString}} {b}Modding{/b} If the {i}Bundle of Backgrounds{/i} mod is installed, you also gain its Concoct Poultice action, which you can use once per encounter instead of once per day.
                  """,
                [],
                null)
            .WithOnSheet(values =>
        ...
        strategist.Subfeats!.Add(alchemicalSciences);
