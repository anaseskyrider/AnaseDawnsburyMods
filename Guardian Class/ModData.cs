...
public static class ModData
{
    ...
    public static class FeatNames
    {
        ...
        public static readonly FeatName GuardiansIntercept = ModManager.RegisterFeatName("GuardianClass.GuardiansIntercept", "Guardian's Intercept");
        public static readonly FeatName ArmoredResistance = ModManager.RegisterFeatName("GuardianClass.ArmoredResistance", "Armored Resistance");
        public static readonly FeatName IroncladFortitude = ModManager.RegisterFeatName("GuardianClass.IroncladFortitude", "Ironclad Fortitude");
