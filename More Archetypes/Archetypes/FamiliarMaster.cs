...
public static class FamiliarMaster
{
    ...
    public static IEnumerable<Feat> CreateFeats()
    {
        ...
        ModData.FeatNames.FamiliarMasterDedication = famDed.FeatName;
        yield return famDed;
        ...
        yield return new TrueFeat(
                ModData.FeatNames.OverloadFamiliar, 4,
            ...
            .WithActionCost(2)
            .WithAvailableAsArchetypeFeat(ModData.Traits.FamiliarMaster)
            .WithOnCreature((sheet, self) =>
            {
                ...
                if (!self.HasEffect(QEffectId.FamiliarAbility))
                ...
                int numDice = (int)Math.Ceiling((double)self.Level / 2);
                    ...
                    $"As {{icon:TwoActions}}two familiar actions, once per day, your familiar explodes in 5-foot emanation for {S.HeightenedVariable(numDice, 2)}d8 Force damage (basic Fortitude save).")
                {
                    ProvideActionIntoPossibilitySection = (qfThis, section) =>
                    {
                        ...
                        if (self.PersistentUsedUpResources.UsedUpActions.Contains(ModData.PersistentActions.OVERLOAD_FAMILIAR))
                            return null;
                        ...
                        return (ActionPossibility)new CombatAction(
                                ...
                                "Overload Familiar",
                                [ModData.ModTrait, Trait.Basic, Trait.Concentrate, Trait.Force, Trait.Magical],
                                $$"""
                            ...
                            {
                                if (self.FindQEffect(QEffectId.FamiliarAbility) is not {} abilityQf)
                                    return;
                                
                                abilityQf.UsedThisTurn = true;
                                self.PersistentUsedUpResources.UsedUpActions.Add(ModData.PersistentActions.OVERLOAD_FAMILIAR);
                                
                                await CommonSpellEffects.DealBasicDamage(
                                    action, self, target, result,
                                    numDice+"d8",
                                    DamageKind.Force);
                            });
                    }
        ...
        yield return new TrueFeat(
                ModData.FeatNames.FastCommand, 6,
                ...
                qfFeat =>
                {
                    qfFeat.ProvideSectionIntoSubmenu = (qfThis, submenuOuter) =>
                    {
                        if (qfThis.Owner.PersistentUsedUpResources.UsedUpActions
                            .Contains(ModData.PersistentActions.FAST_COMMAND))
                            return null;
                        ...
                        CombatAction fastCommand = new CombatAction(
                                ...
                                "Fast Command",
                                [ModData.ModTrait, Trait.Concentrate, Trait.Basic],
                                """
                            ...
                            .WithEffectOnEachTarget(async (_, _, target, _) =>
                            {
                                ...
                                qfThis.Owner.PersistentUsedUpResources.UsedUpActions
                                    .Add(ModData.PersistentActions.FAST_COMMAND);
        ...
        yield return new TrueFeat(
                ModData.FeatNames.MutableFamiliar, 8,
        ...
        yield return new TrueFeat(
                ModData.FeatNames.IncredibleFamiliar, 10,
